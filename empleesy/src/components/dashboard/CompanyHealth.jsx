            ...
            <div className='bg-slate-100 p-4 rounded-[21px] mt-2'>
                ...
                <div className="mt-5">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg px-8 py-4  border border-slate-200 w-full">
                        ...
                        <div className="grid md:grid-cols-2 w-full gap-6">
                            {healthData.metrics.map((metric, index) => {
                                ...
                                return (
                                    <div key={index} className="bg-white rounded-xl shadow-md h-[12rem] p-6 border border-slate-200 hover:shadow-lg transition-shadow w-full mt-6">
                                        <div className="flex items-start justify-between mb-4">
                                            <div className="flex items-center gap-3">
                                                <div className={`p-3 rounded-lg ${getStatusColor(metric.status)} bg-opacity-10`}>
                                                    <Icon className={`w-4 h-4 ${getStatusColor(metric.status).replace('bg-', 'text-')}`} />
                                                </div>
                                                <div>
                                                    <h3 className="font-semibold text-[12px] text-slate-800">{metric.name}</h3>
                                        ...
                                        <div className="flex items-end justify-between ">
                                            ...
                                            <div className="text-right">
                                                <div className="text-[12px] font-medium text-slate-600 mb-1">Health Score</div>
