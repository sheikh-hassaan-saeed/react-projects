        ...
        <div className="flex flex-col ml-6 mt-12 gap-2">
            {links.map((link, index) => (
                <div
                    ...
                    className={`flex items-center gap-3 cursor-pointer text-[16px] text-stone-700 font-medium  hover:text-stone-900  transition-colors px-4 py-2 rounded-lg w-[220px] text-left ${activeIndex === index
